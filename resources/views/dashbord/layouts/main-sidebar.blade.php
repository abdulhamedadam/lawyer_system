            ...
            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3" id="#kt_app_sidebar_menu"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.main_dash') ? 'active' : '' }}"
                        ...
                        <span class="svg-icon svg-icon-2" style="margin-left: 5px">
                            <i class="bi bi-graph-up text-warning fs-2x"></i>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs(['admin.general_settings', 'jobs', 'admin.archive_shelf_settings', 'shelf', 'admin.archive_settings', 'desk']) ? 'active' : '' }}"
                        ...
                        <span class="svg-icon svg-icon-2" style="margin-left: 5px">
                            <i class="bi bi-gear text-warning fs-2x"></i>
                            <!-- Replace with the desired Bootstrap Icon class -->
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.Mraf3at.index') ? 'active' : '' }}"
                        href="{{ route('admin.Mraf3at.index') }}">
                        <span class="svg-icon svg-icon-2" style="margin-left: 5px">
                            <i class="bi bi-archive text-warning fs-2x"></i>
                        </span>
                        <span class="menu-title">{{ translate('Mraf3at') }}</span>
                    </a>
                </div>

                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.edary_work.index') ? 'active' : '' }}"
                        href="{{ route('admin.edary_work.index') }}">
                        <span class="svg-icon svg-icon-2" style="margin-left: 5px">
                            <i class="bi bi-file-earmark-text text-warning fs-2x"></i>
                        </span>
                        <span class="menu-title">{{ translate('edary_work') }}</span>
                    </a>
                </div>
              ...
              <span class="bullet bullet-dot"></span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.library_data') ? 'active' : '' }}"
                        ...
                        <span class="svg-icon svg-icon-2" style="margin-left: 5px">
                            <i class="bi bi-book text-warning fs-2x"></i>
                            <!-- Replace with the desired Bootstrap Icon class -->
                        </span>
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.daily_reports_data') ? 'active' : '' }}"
                        ...
                        <span class="svg-icon svg-icon-2" style="margin-left: 5px">
                            <i class="bi bi-file-text text-warning fs-2x"></i>
                            <!-- Replace with the desired Bootstrap Icon class -->
                        </span>
