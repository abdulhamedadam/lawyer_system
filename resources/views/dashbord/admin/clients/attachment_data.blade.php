                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if (in_array($ext, $image))
                            <i class="bi bi-image fs-2x" aria-hidden="true" title="{{ $f_title }}"></i>
                        @elseif (in_array($ext, $file))
                            <i class="bi bi-file-earmark-pdf fs-2x" aria-hidden="true" title="{{ $f_title }}"></i>
                        @endif
                    </td>
                    <td>
                        @if (in_array($ext, $image))
                            <a data-bs-toggle="modal" data-bs-target="#myModal-view-{{ $morfaq->id }}">
                                <i class="bi bi-eye fs-2x" title="{{ __('view_file') }}"></i>
                            </a>
                            ...
                            <div class="modal fade" tabindex="-1" id="myModal-pdf-{{ $morfaq->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <iframe src="{{ route('admin.read_file',$morfaq->id) }}" style="width: 100%; height: 640px;" frameborder="0"></iframe>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('admin.download_file', $morfaq->id) }}" class="btn btn-sm btn-primary" title="{{ translate('download') }}">
                                <i class="bi bi-download"></i>
                            </a>
                            <a href="{{ route('admin.delete_file', $morfaq->id) }}" onclick="return confirm('Are You Sure To Delete?')" class="btn btn-sm btn-danger">
