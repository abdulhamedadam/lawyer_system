    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" >
        <div id="kt_app_content_container" class="t_container" >
            <div class="card shadow-sm " style="border-top: 3px solid #007bff;">
                ...
                <form  action="{{ route('admin.save_archive') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-12 row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="input-group flex-nowrap ">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select "  name="related_entity_id" id="related_entity_id" data-control="select2" data-show-subtext="true" data-live-search="true" data-placeholder="{{ translate('select') }}">
                                            <option value="">{{ translate('select') }}</option>
                                        </select>
                                    </div>
                                </div>
