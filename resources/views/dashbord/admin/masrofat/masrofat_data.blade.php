        ...
        <div id="kt_app_content_container" class="t_container"  >
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                <div class="card-header">
                    <h3 class="card-title">{{ translate('masrofat') }}</h3>
                    <div class="card-toolbar">
                        <div class="text-center">
                            <a class="btn btn-primary" href="{{ route('admin.add_masrofat') }}">
                                <i class="bi bi-plus fs-1"></i> {{ translate('add_new_masrof') }}
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="">
                        <table id="table1" class="table table-bordered" style="table-layout: fixed;">
                            ...
                            <tr class="fw-bold fs-6 text-gray-800">
                                ...
                                <th style="text-align: center"><i class="fas fa-user"></i> {{ translate('band_name') }}</th>
                                <th style="text-align: center"><i class="fas fa-file-alt"></i> {{ translate('value') }}</th>
                                <th style="text-align: center"><i class="fas fa-folder"></i> {{ translate('cashier') }}</th>
                                <th style="text-align: center"><i class="fas fa-folder"></i> {{ translate('notes') }}</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table1').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "{{ route('admin.ajax_data') }}",
                },
                "columns": [
                    { data: 'id', className: 'text-center' },
                    { data: 'related_to_case', className: 'text-center' },
                    { data: 'band_name', className: 'text-center' },
                    { data: 'value', className: 'text-center' },
                    { data: 'cashier', className: 'text-center' },
