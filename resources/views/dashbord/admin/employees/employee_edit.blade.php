    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" >
        <div id="kt_app_content_container" class="t_container" >
            <div class="card shadow-sm " style="border-top: 3px solid #007bff;">
                ...
                <form action="{{ route('admin.update_employee',$all_data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-12 row">
                            <div class="col-md-2">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control" name="employee_code" id="employee_code" value="{{ $all_data->emp_code }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control" name="employee_name" id="employee_name" value="{{ old('employee_name',$all_data->employee) }}" aria-describedby="basic-addon3">
                                </div>
                                @error('employee_name')
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="nationality_id" id="nationality_id"    data-placeholder="{{translate('select')}}">
                                            ...
                                            @foreach($nationalites as $item)
                                                <option value="{{$item->id}}" {{ old('nationality_id',$all_data->nationality) == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="gender" id="gender"   data-placeholder="{{translate('select')}}">
                                            ...
                                            @foreach($gender as $item)
                                                <option value="{{$item->id}}"{{ old('gender',$all_data->gender) == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-caret-down fs-2"></i></span>
                                    <input type="number"  class="form-control " name="national_id" maxlength="14" id="national_id" value="{{old('national_id',$all_data->card_num)}}" aria-describedby="basic-addon3">
                                </div>
                                @error('national_id')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
                        ...
                        <div class=" col-md-12 row" style="margin-top: 10px">
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap ">
                                    ...
                                    <input type="date"  class="form-control"  name="date_of_barth"  id="date_of_barth" value="{{old('date_of_barth',$all_data->birth_date)}}"  aria-describedby="basic-addon3">
                                </div>
                                @error('date_of_barth')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap ">
                                    ...
                                    <input type="text"  class="form-control " name="address"  id="address" value="{{old('address',$all_data->address)}}"  aria-describedby="basic-addon3">
                                </div>
                                @error('address')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="religion" id="religion"   data-placeholder="{{translate('select')}}">
                                            ...
                                            @foreach($religions as $item)
                                                <option value="{{$item->id}}" {{ old('religion',$all_data->deyana) == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="marital_status" id="marital_status"   data-placeholder="{{translate('select')}}">
                                            ...
                                            @foreach($material_status as $item)
                                                <option value="{{$item->id}}" {{ old('marital_status',$all_data->material_status) == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="job_title" id="job_title" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($jobs as $item)
                                                <option value="{{ $item->id }}" {{ old('job_title',$all_data->mosma_wazefy_code) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-geo-alt fs-2"></i></span>
                                    <input type="text" class="form-control" name="phone_number" id="phone_number" value="{{ old('phone_number',$all_data->phone) }}" aria-describedby="basic-addon3">
                                </div>
                                @error('phone_number')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <input type="text" class="form-control" name="whats_number" id="whats_number" value="{{ old('whats_number',$all_data->whatsapp) }}" aria-describedby="basic-addon3">
                                </div>
                                @error('whats_number')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="governate_id" id="governate_id" onchange="get_city(this.value)" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($governates as $item)
                                                <option value="{{ $item->id }}" {{ old('governate_id',$all_data->governate_id_fk) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-calendar fs-2"></i></span>
                                    <input type="date" class="form-control" name="start_work_date" id="start_work_date" value="{{ old('start_work_date',$all_data->start_work_date) }}" aria-describedby="basic-addon3">
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-calendar fs-2"></i></span>
                                    <input type="date" class="form-control" name="end_contract_date" id="end_contract_date" value="{{ old('end_contract_date',$all_data->end_contract_date) }}" aria-describedby="basic-addon3">
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-calendar fs-2"></i></span>
                                    <input type="number" class="form-control" name="test_num_month" id="test_num_month" value="{{ old('test_num_month',$all_data->test_num_month) }}" aria-describedby="basic-addon3">
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-calendar fs-2"></i></span>
                                    <input type="date"  class="form-control"  name="end_test_date"  id="end_test_date" value="{{old('end_test_date',$all_data->end_test_date)}}"  aria-describedby="basic-addon3">
                                </div>
                                @error('end_test_date')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="manager" id="manager" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($emolyees as $item)
                                                <option value="{{ $item->id }}" {{ old('manager',$all_data->manager) == $item->id ? 'selected' : '' }}>{{ $item->employee }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="qualifications" id="qualifications" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($qualifications as $item)
                                                <option value="{{ $item->id }}" {{ old('qualifications',$all_data->employee_qualification) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="degrees" id="degrees" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($degrees as $item)
                                                <option value="{{ $item->id }}" {{ old('degrees',$all_data->employee_degree) == $item->id ? 'selected' : '' }}>{{ $item->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
        ...
        function get_city(id)
        {
            $.ajax({
                ...
                success: function (html) {
                    $('#city_id').html(html);
                    $('#city_id').val(<?= old('city_id',$all_data->city_id_fk)?> );
