        ...
        <div id="kt_app_content_container" class="t_container"  >
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                <div class="card-header">
                    <h3 class="card-title">{{ translate('incomming_tasks') }}</h3>
                    ...
                    <div class="table-responsive" >
                        <table id="table1" class="table table-bordered">
                            ...
                            <tbody>
                             ...
                             <div class="modal fade" tabindex="-1" id="modalestlam">
...
@section('js')
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                table = $("#table1").DataTable({
                    ...
                    stateSave: true,
                    ajax: {
                        url: "{{ route('admin.get_ajex_wared_tasks') }}",
                    },
                    columns: [
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Admin\task\EstlamTaskRequest', '#estlam_form') !!}
