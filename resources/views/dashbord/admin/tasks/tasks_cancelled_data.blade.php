                    ...
                    <div class="table-responsive" >
                        <table id="table1" class="table table-bordered">
                            ...
                            <tr class="fw-bold fs-6 text-gray-800">
                                ...
                                <th style="width: 8%;text-align: center"> {{ translate('refused_reason') }}</th>
                                <th style="width: 8%;text-align: center"> {{ translate('refused_date') }}</th>
...
@section('js')
        ...
        var KTDatatablesServerSide = function () {
            ...
            var initDatatable = function () {
                table = $("#table1").DataTable({
                    ...
                    stateSave: true,
                    ajax: {
                        url: "{{ route('admin.get_ajex_cancelled_tasks') }}",
                    },
                    columns: [
                        ...
                        { data: 'refused_reason', className: 'text-center' },
                        { data: 'refused_date', className: 'text-center' },
    ...
    <script>
        function estlam_pop_forms(id)
        {
            $.ajax({
                url: "{{ route('admin.estlam_task', ['id' => '__id__']) }}".replace('__id__', id),
                type: "get",
                dataType: "html",
