<form action="{{ route('admin.edary_work_update_payments', $payments->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-12 row">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="date" class="form-control" name="paid_date" id="paid_date" value="{{old('paid_date', $payments->paid_date)}}" aria-describedby="basic-addon3">
            </div>
            @error('paid_date')
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="person_name" id="person_name" value="{{old('person_name', $payments->person_name)}}" aria-describedby="basic-addon3">
            </div>
            @error('person_name')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="person_phone" id="person_phone" value="{{old('person_phone', $payments->person_phone)}}" aria-describedby="basic-addon3">
            </div>
            @error('person_phone')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
    ...
    <div class="col-md-12 row" style="margin-top: 20px">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="number" step="0.01" class="form-control" name="paid_value" id="paid_value" value="{{old('paid_value', $payments->paid_value)}}" aria-describedby="basic-addon3">
            </div>
            @error('paid_value')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-8">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="notes" id="notes" value="{{old('notes', $payments->notes)}}" aria-describedby="basic-addon3">
            </div>
            @error('notes')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
