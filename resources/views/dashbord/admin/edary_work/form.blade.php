        ...
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                <div class="card-header">
                    <h3 class="card-title"></i> {{ translate('add_edary_work') }}</h3>
                    <div class="card-toolbar">
                        {!! create_button(route('admin.edary_work.index'), translate('back')) !!}

                    </div>
                </div>
                <form action="{{ route('admin.edary_work.store') }}" method="post" enctype="multipart/form-data"
                    id="form_store">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-12 row">
                            <div class="col-md-3" >
                                ...
                                <div class="input-group flex-nowrap ">
                                    ...
                                    <input type="date"  class="form-control " name="estlam_date"  id="estlam_date" value="{{old('estlam_date')}}"  aria-describedby="basic-addon3" >
                                </div>
                                @error('estlam_date')
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('date') !!}</span>
                                    <input type="date"  class="form-control " name="date_authority"  id="date_authority" value="{{old('date_authority')}}"  aria-describedby="basic-addon3" >
                                </div>
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="input-group flex-nowrap ">
                                    ...
                                    <input type="text"  class="form-control " name="phone"  id="phone" value="{{ old('phone') }}"  aria-describedby="basic-addon3" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            ...
                            <div class="col-md-3" >
                                <label for="basic-url"class="form-label">{{translate('edary_work_type')}}</label>
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('select') !!}</span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="edary_work_type" id="edary_work_type" data-placeholder="{{translate('select')}}">
                                            <option value="">{{translate('select')}}</option>
                                            @foreach($edary_types as $item)
                                                <option value="{{$item->id}}" {{ old('edary_work_type') == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="esnad_to_id" id="esnad_to_id"
                                            ...
                                            @foreach ($emps as $item)
                                                <option value="{{ $item->id }}" {{ old('esnad_to_id') == $item->id ? 'selected' : '' }}>
                                                    {{ $item->employee }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <input type="text"  class="form-control " name="subject_entity"  id="subject_entity" value="{{old('subject_entity')}}"  aria-describedby="basic-addon3" >
                                </div>
                            ...
                            <div class="col-md-3" >
                                <label for="authority_entity"class="form-label">{{translate('authority_entity')}}</label>
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <input type="text"  class="form-control " name="authority_entity"  id="authority_entity" value="{{old('authority_entity')}}"  aria-describedby="basic-addon3" >
                                </div>
                            ...
                            <div class="col-md-3" >
                                <label for="subject_entity_address"class="form-label">{{translate('subject_entity_address')}}</label>
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <input type="text"  class="form-control " name="subject_entity_address"  id="subject_entity_address" value="{{old('subject_entity_address')}}"  aria-describedby="basic-addon3" >
                                </div>
                            ...
                            <div class="col-md-3" >
                                ...
                                <div class="input-group flex-nowrap ">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <input type="number"  class="form-control " name="total_fees"  id="total_fees" value="{{old('total_fees')}}"  aria-describedby="basic-addon3" >
                                </div>
                                @error('total_fees')
                                <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
                                @enderror
