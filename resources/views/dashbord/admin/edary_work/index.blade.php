    ...
    <div id="kt_app_content" class="app-content flex-column-fluid" >
        <div id="kt_app_content_container" class="t_container"  >
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                ...
                @php
                    generateCardHeader('edary_work', 'admin.edary_work.create', 'add');
                    $headers = [
                        'hash',
                        'client_name',
                        'esnad_to',
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#table1').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "{{ route('admin.edary_work.index') }}",
                },
                "columns": [
                    { data: 'id', className: 'text-center' },
                    { data: 'client_name', className: 'text-center' },
                    { data: 'esnad_to', className: 'text-center' },
                    { data: 'estlam_date', className: 'text-center' },
                    { data: 'tawkel_num', className: 'text-center' },
                    { data: 'tawkel_type', className: 'text-center' },
                    { data: 'tawkel_authority', className: 'text-center' },
                    { data: 'date_authority', className: 'text-center' },
                    { data: 'fees', className: 'text-center' },
                    { data: 'edary_work_type', className: 'text-center' },
