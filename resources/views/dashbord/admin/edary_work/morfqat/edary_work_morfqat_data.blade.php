                ...
                @foreach ($files_data as $morfaq)
                    ...
                    <tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="{{ asset(Storage::disk('files')->url($morfaq->file)) }}"
                                                    width="100%" alt="">
                                            </div>
                                ...
                                <div class="modal fade" tabindex="-1" id="myModal-pdf-{{ $morfaq->id }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <iframe src="{{ route('admin.edary_work_read_file', $morfaq->id) }}"
                        ...
                        <td class="fnt_center_black">
                            {{ \Illuminate\Support\Carbon::parse($morfaq->created_at)->format('Y-m-d') }}</td>
                        <td class="fnt_center_red">
                            {{ \Illuminate\Support\Carbon::parse($morfaq->created_at)->format('H:i:s') }}</td>
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('admin.edary_work_download_file', $morfaq->id) }}"
                                    class="btn btn-sm btn-primary" title="{{ translate('download') }}">
                                    <i class="bi bi-download"></i>
                                </a>
                                <a href="{{ route('admin.edary_work_delete_file', $morfaq->id) }}"
