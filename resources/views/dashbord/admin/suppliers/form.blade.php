    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                ...
                <form action="{{ route('admin.Suppliers.store') }}" method="post" enctype="multipart/form-data" id="form_store">
                    @csrf
                    <div class="card-body">
                        <div class="col-md-12 row">
                            <div class="col-md-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="name" id="name" value="{{old('name')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="company_name" id="company_name" value="{{old('company_name')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="address" id="address" value="{{old('address')}}">
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="phone_number" id="phone_number" value="{{old('phone_number')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="tax_record" id="tax_record" value="{{old('tax_record')}}">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group flex-nowrap">
                                    <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="commercial_record" id="commercial_record" value="{{old('commercial_record')}}">
