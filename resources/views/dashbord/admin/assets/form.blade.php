    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="t_container">
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                ...
                <form action="{{ route('admin.Assets.store') }}" method="post" enctype="multipart/form-data" id="form_store">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <input class="form-control rounded-start-0" name="asset_name" id="asset_name" value="{{old('asset_name')}}">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="assets_type" id="assets_type" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($assets_types as $item)
                                                <option value="{{ $item->id }}" {{ old('assets_type') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select class="form-select rounded-start-0" name="received_by" id="received_by" data-placeholder="{{ translate('select') }}">
                                            ...
                                            @foreach($employees as $item)
                                                <option value="{{ $item->id }}" {{ old('received_by') == $item->id ? 'selected' : '' }}>{{ $item->employee }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12 row" style="margin-top: 10px">
                            <div class="col-md-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <input type="number" class="form-control rounded-start-0" name="purchases_value" id="purchases_value" value="{{old('name')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <input type="date" class="form-control rounded-start-0" name="purchases_date" id="purchases_date" value="{{old('purchases_date')}}">
