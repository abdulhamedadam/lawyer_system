                    ...
                    <div id="kt_app_content_container" class="" style="padding-top: 20px" >
                        <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                            <div class="card-header">
                                <h3 class="card-title">{{ translate('assets_typ') }}</h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?=translate('assets_typ')?></h3>
                ...
                <form method="post" action="{{route('admin.add_assets_type')}}" enctype="multipart/form-data" id="form">
                    @csrf
...
@section('js')
    ...
    <script>
        ...
        {
            $.ajax({
                url: "{{ route('admin.edit_assets_type', ['id' => '__id__']) }}".replace('__id__', id),
                type: "get",
                dataType: "json",
