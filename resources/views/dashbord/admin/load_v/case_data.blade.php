    ...
    <div class="card-body" style="padding: 20px !important;">
        <table class="table table-bordered table-sm table-striped">
            <tbody>
                ...
                <tr>
                    <td class="class_label"><?= translate('court') ?></td>
                    <td class="class_result"><?php echo $all_data->court; ?></td>
                </tr>
                <tr>
                    <td class="class_label"><?= translate('case_status') ?></td>
                    <td class="class_result"><?php echo $all_data->case_status; ?></td>
                ...
                <tr>
                    <td class="class_label"><?= translate('khesm_name') ?></td>
                    <td class="class_result"><?php echo $all_data->khesm_name; ?></td>
                </tr>
                {{-- <tr>
                    <td class="class_label"><?= translate('start_date') ?></td>
                    <td class="class_result"><?php echo $all_data->start_date ? $all_data->start_date : 'No start date available'; ?></td>
                </tr> --}}
                ...
                <tr style="background-color: #cd1e59">
                    ...
                    <td class="class_result"><?php echo sprintf("%.2f", ($all_data->fees - 1)); ?></td>
                </tr>
            </tbody>
        </table>
