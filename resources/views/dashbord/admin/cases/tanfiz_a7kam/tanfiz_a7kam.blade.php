        ...
        <div id="kt_app_content_container" class="t_container">
            ...
            <div class="card shadow-sm" style="border-top: 3px solid #007bff;">
                <div class="card-header" style="background-color: #f8f9fa;">
                    <h3 class="card-title"></i> {{translate('tanfiz_a7kam')}}</h3>
                ...
                <div class="card-body" style="padding-left: 0px !important;">
                    <div class="col-md-12 row">
                        <div class="col-md-8">
                            @include('dashbord.admin.cases.tanfiz_a7kam.tanfiz_a7kam_form')
                            @include('dashbord.admin.cases.tanfiz_a7kam.tanfiz_a7kam_data')
                        </div>
                        <div class="col-md-4">
