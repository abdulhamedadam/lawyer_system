...
<form action="{{ route('admin.add_tanfiz_a7kam',$all_data->id) }}" method="post" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="partial_num" id="partial_num"
                    value="{{old('partial_num')}}" aria-describedby="basic-addon3">
            </div>
            @error('partial_num')
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="tanfiz_circle" id="tanfiz_circle"
                    value="{{old('tanfiz_circle')}}" aria-describedby="basic-addon3">
            </div>
            @error('tanfiz_circle')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="elkady_name" id="elkady_name"
                    value="{{old('elkady_name')}}" aria-describedby="basic-addon3">
            </div>
            @error('elkady_name')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="elmarkaz" id="elmarkaz"
                       value="{{old('elmarkaz')}}" aria-describedby="basic-addon3">
            </div>
            @error('elmarkaz')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="date" class="form-control" name="el7okm_date" id="el7okm_date"
                       value="{{old('el7okm_date')}}" aria-describedby="basic-addon3">
            </div>
            @error('el7okm_date')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
            ...
            <div class="overflow-hidden flex-grow-1">
                <select class="form-select rounded-start-0" name="court" id="court"
                    ...
                    @foreach($courts as $item)
                        <option
                            value="{{$item->id}}" {{ old('court') == $item->id ? 'selected' : '' }}>{{$item->title}}</option>
                    @endforeach
                </select>
            </div>
        </div>
    ...
    <div class="col-md-12" style="margin-top: 10px">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="el7okm" name="el7okm" rows="3">{{old('el7okm')}}</textarea>
            @error('el7okm')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        </div>
