...
<form action="{{ route('admin.update_kafalate',$kafalate_data->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-12 row">
        ...
        <div class="col-md-2">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="kafala_num" id="kafala_num"
                       value="{{old('kafala_num',$kafalate_data->kafala_num)}}" aria-describedby="basic-addon3">
            </div>
            @error('kafala_num')
                ...
                <div class="overflow-hidden flex-grow-1">
                    <select class="form-select rounded-start-0" name="year" id="year"
                        ...
                        @foreach($years as $item)
                            <option
                                value="{{$item}}" {{ old('year',$kafalate_data->year) == $item ? 'selected' : '' }}>{{$item}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                <span class="input-group-text" id="basic-addon3">{!! form_icon('text') !!}</span>
                <input type="tex" class="form-control" name="qasema_num" id="qasema_num"
                       value="{{old('qasema_num',$kafalate_data->qasema_num)}}" aria-describedby="basic-addon3">
            </div>
            @error('qasema_num')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="text" class="form-control" name="paper_num" id="paper_num"
                       value="{{old('paper_num',$kafalate_data->paper_num)}}" aria-describedby="basic-addon3">
            </div>
            @error('paper_num')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="number" class="form-control" name="kafala_value" id="kafala_value"
                       value="{{old('mo7dareen_pen',$kafalate_data->kafala_value)}}" aria-describedby="basic-addon3">
            </div>
            @error('kafala_value')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        ...
        <div class="col-md-4">
            ...
            <div class="input-group flex-nowrap">
                ...
                <input type="date" class="form-control" name="payment_date" id="payment_date"
                       value="{{old('payment_date',$kafalate_data->payment_date)}}" aria-describedby="basic-addon3">
            </div>
            @error('payment_date')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
    ...
    <div class="col-md-12" style="margin-top: 10px">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="al7ukm" name="al7ukm" rows="3">{{old('al7ukm',$kafalate_data->al7ukm)}}</textarea>
            @error('al7ukm')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="col-md-12" style="margin-top: 10px">
        <div class="mb-3">
            ...
            <textarea class="form-control" id="notes" name="notes" rows="3">{{old('notes',$kafalate_data->notes)}}</textarea>
            @error('notes')
            <span class="invalid-feedback d-block" role="alert">{{ $message }}</span>
            @enderror
        </div>
